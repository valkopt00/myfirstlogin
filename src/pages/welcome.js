  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col p-5">
      ...
      <div className="flex flex-col max-w-3xl w-full mx-auto" style={{ height: "calc(100vh - 40px)" }}>
        ...
        <div className="flex-1 flex flex-col border border-gray-700 rounded-md bg-gray-800 overflow-hidden">
          ...
          {/* Área de input fixa na parte inferior - Não usa flex-1, altura baseada no conteúdo */}
          <div className="p-4 border-t border-gray-700 bg-gray-800 sticky bottom-0">
            <div className="flex items-center">
              <input
                ...
                className="flex-1 p-3 border border-gray-600 rounded-md text-amber-200 bg-transparent focus:outline-none focus:border-amber-400"
                placeholder="Digite sua mensagem..."
              />
              <button
                onClick={sendMessage}
                className="ml-2 px-5 py-3 bg-amber-200 text-black rounded-md hover:bg-amber-300 transition-colors"
              >
                Send
              </button>
            </div>
